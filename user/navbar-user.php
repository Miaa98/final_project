...
<nav class="navbar navbar-expand-lg fixed-top">
    <div class="container-fluid">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                    <li class="nav-item">
                        <a class="nav-link mx-lg-2" aria-current="page" href="dashboard-user.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mx-lg-2" href="reservasi.php">Reservasi</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="d-flex align-items-center">
            <!-- Cart Icon -->
            <a href="keranjang-user.php" class="nav-link me-3" role="button" aria-label="Keranjang">
                <i class="bi bi-cart4" style="font-size: 24px; color: white;"></i>
            </a>
